...
- **🖱️ Smart Input Separation**: Desktop mouse cursor is dedicated to UI interactions (Mute sound, Main Menu, Shop, Restart) without interfering with player movement controls.
